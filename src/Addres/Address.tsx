...
export const Address: React.FC = () => {
    ...
    return (    
        <>
            <p className='text'>Подтвердите своё согласие на проведение вечера с классным Мэном</p>
            <div className='container-button'>
                <button className='agree' onClick={handleOk}>Согласна</button>
                <button className='no' onClick={handleNo}>Отказываюсь</button>
            </div>
            <ReactPlayer 
             url='https://github.com/Virotor/love/blob/master/public/happy-cat.mp4'
             playing
             loop
             muted
             controls={false}
            />
            <p className='text'>Для связи с нами вы можете воспользоваться</p>
